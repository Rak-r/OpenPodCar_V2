...
def generate_launch_description():
	...
	path_to_urdf = PathJoinSubstitution([FindPackageShare("pod2_description"), "xacro", "sample_velodyne.urdf"])
	
	rviz_config_path = PathJoinSubstitution([FindPackageShare("pod2_description"), "rviz2", "description.rviz"])
	
	robot_description = ParameterValue(
        Command(['xacro ', str(get_package_share_path('pod2_description') / 'xacro/sample_velodyne.urdf')]),
        value_type=str)
